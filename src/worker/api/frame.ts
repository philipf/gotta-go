...
export function handleFrame(request: Request, env: Env, now: Date): Promise<Response> {
...
export async function renderFrame(request: Request, env: Env, now: Date, resolve: RadiatorResolver): Promise<Response> {

...
describe('fetchJoke', () => {
  it('maps a 200 JSON joke into the domain Joke', async () => {
    const stubFetch: typeof fetch = async () => new Response(JSON.stringify(classicJoke), { status: 200 });
  ...
  it('trims surrounding whitespace from the joke text', async () => {
    const stubFetch: typeof fetch = async () => new Response(JSON.stringify(paddedJoke), { status: 200 });
  ...
  it('classifies a non-2xx as an upstream error carrying status + body snippet', async () => {
    const stubFetch: typeof fetch = async () => new Response('upstream boom', { status: 503 });
  ...
  it('treats a 200 with malformed JSON as an upstream error, preserving the parse cause', async () => {
    const stubFetch: typeof fetch = async () => new Response('not json', { status: 200 });
  ...
  it('treats a 200 with an empty joke field as an upstream error', async () => {
    const stubFetch: typeof fetch = async () => new Response(JSON.stringify({ id: 'x', joke: '   ', status: 200 }), { status: 200 });

...
export type FrameDeps = {
  ...
  // binding-driven per ADR-0005 §DI. Transit-only: priority_split_v2 is the sole
  // consumer.
...
export type LayoutKey = 'minimal_clock' | 'priority_split_v2' | 'idle_jokes' | 'dual_month_calendar';

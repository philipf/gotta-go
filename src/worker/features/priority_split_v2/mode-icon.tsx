...
// header.
//
// Self-contained copy for priority_split_v2 (issue #102): v2 stands up beside
// v1 as a clean folder so removing v1 later is a plain delete. The icon is a
// small, stable helper, so it is duplicated here rather than promoted to a
// shared tier — the architecture guide's "share at the second *real* need".
// When v1 is deleted, this becomes the sole copy.
//
...
// render time (no bundled asset, no fetch, no new wrangler rule).

  ...
  return (
    <div
      ...
      style={{
        ...
        ...(opts.shaded && !opts.inverted ? { backgroundImage: `url("${SHADE_TILE}")`, backgroundSize: '2px 2px' } : {}),
      }}
    >
      {content}
    </div>
...
function layout(vm: ViewModel): ReactNode {
  return (
    ...
    >
      {/* Self-positioning top-right; null when the reading is absent. The date
          header is centred, so the top-right corner is clear (#132); verified
          live per ADR-0009. */}
